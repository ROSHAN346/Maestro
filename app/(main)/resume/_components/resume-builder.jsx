...
export default function ResumeBuilder({ initialContent }) {
  ...
  resume.querySelectorAll("*").forEach((el) => {
    ...
    // Override unsupported background colors
    const bg = computedStyle.backgroundColor;
    if (bg.includes("oklch")) {
      el.style.backgroundColor = "#ffffff"; // fallback white
    }

    // Override unsupported text colors
    const color = computedStyle.color;
    if (color.includes("oklch")) {
      el.style.color = "#000000"; // fallback black
    }
  });
};
